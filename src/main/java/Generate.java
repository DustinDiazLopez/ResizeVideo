...
public class Generate {
    ...
    private static ArrayList<String> getFiles() {
        ...
        File path = new File("E:\\bck\\Algoexpert\\Data Structure Crash Course - Copy");
...
//        System.out.print(builder.toString() + "echo \"FIN.\"");
        ...
        System.out.println(generateCommandArg("C:\\Users\\dudia\\Desktop\\Projects\\Video-Player\\videos\\bunny-vid-id\\mov_bbb.mp4", "1/1"));
